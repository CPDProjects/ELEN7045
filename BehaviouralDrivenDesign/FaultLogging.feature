...
Scenario: Member of public logs a fault with call operator
	Given call-centre 'fault-operator' is available
	...
	And fault-operator must use streetadress 'address' to determine the gps co-ordinates 'longitude' and 'latitude'
